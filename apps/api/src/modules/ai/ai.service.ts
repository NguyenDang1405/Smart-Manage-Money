...
// 1. Khởi tạo client với API Key từ biến môi trường
const apiKey = process.env.EXPO_PUBLIC_HUGGINGFACE_API_KEY || process.env.HF_API_KEY || process.env.HUGGINGFACE_API_KEY;
